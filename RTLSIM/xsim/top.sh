...
#
# Script generated by xsim on Wed Feb 28 07:23:22 +03 2024
...
# script info
echo -e "top.sh - Script generated by export_simulation (xsim v2023.2.2 (64-bit)-id)\n"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/omerfaruk/tools/Xilinx/Vivado/2023.2/data/xsim"
  fi
